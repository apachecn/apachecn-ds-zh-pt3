...
![$$ {x}^{\ast }=\underset{x}{\min }f(x) $$](img/500382_1_En_9_Chapter_TeX_Equa.png)
...
![img/500382_1_En_9_Fig1_HTML.png](img/500382_1_En_9_Fig1_HTML.png)
...
![img/500382_1_En_9_Fig2_HTML.png](img/500382_1_En_9_Fig2_HTML.png)
...
![img/500382_1_En_9_Fig3_HTML.png](img/500382_1_En_9_Fig3_HTML.png)
...
![img/500382_1_En_9_Fig4_HTML.jpg](img/500382_1_En_9_Fig4_HTML.jpg)
...
![$$ {I}_{k+1}={I}_{k+1}^L={I}_{k+1}^R $$](img/500382_1_En_9_Chapter_TeX_Equb.png)

![$$ {I}_k={I}_{k+1}^L+{I}_{k+2}^R={I}_{k+1}+{I}_{k+2} $$](img/500382_1_En_9_Chapter_TeX_Equc.png)

对于 *n* 次迭代，我们有如下递归关系:

![$$ {I}_1={I}_2+{I}_3 $$](img/500382_1_En_9_Chapter_TeX_Equd.png)

![$$ {I}_2={I}_3+{I}_4 $$](img/500382_1_En_9_Chapter_TeX_Eque.png)

![$$ \cdots $$](img/500382_1_En_9_Chapter_TeX_Equf.png)

![$$ {I}_n={I}_{n+1}+{I}_{n+2} $$](img/500382_1_En_9_Chapter_TeX_Equg.png)
...
![$$ {I}_{n+1}={F}_0{I}_n $$](img/500382_1_En_9_Chapter_TeX_Equh.png)

![$$ {I}_n={F}_0{I}_n $$](img/500382_1_En_9_Chapter_TeX_Equi.png)

![$$ {I}_k={F}_{n-k+1}{I}_n $$](img/500382_1_En_9_Chapter_TeX_Equj.png)

![$$ {I}_1={F}_n{I}_n $$](img/500382_1_En_9_Chapter_TeX_Equk.png)

其中

![$$ {F}_k={F}_{k-1}+{F}_{k-2},k\ge 2 $$](img/500382_1_En_9_Chapter_TeX_Equl.png)
...
![$$ \frac{I_k}{I_{k+1}}=K,\forall k $$](img/500382_1_En_9_Chapter_TeX_Equm.png)

利用这两个方程，我们可以解出 *K* ，如下图:

![$$ {K}^2=K+1 $$](img/500382_1_En_9_Chapter_TeX_Equn.png)

![$$ K=\frac{1+\sqrt{5}}{2}\approx 1.618034 $$](img/500382_1_En_9_Chapter_TeX_Equo.png)

这个数字被称为黄金比例。音程顺序如下:

![$$ \left\{\ {I}_1,\frac{I_1}{K},\frac{I_1}{K^2},\dots \dots, \frac{I_1}{K^{n-1}}\right\} $$](img/500382_1_En_9_Chapter_TeX_Equp.png)

举个例子:{100，61.8，38.2，23.6，14.6，9，…}。这可以在没有预定的 *n* 的情况下继续进行。

我们可以比较黄金分割搜索和斐波那契搜索的效率。*F*<sub>T3】nT5】和 *K* 的关系为![$ {F}_n\approx \frac{K^{n+1}}{\sqrt{5}} $](img/500382_1_En_9_Chapter_TeX_IEq1.png)。斐波纳契搜索中的不确定区域如下:</sub>

![$$ {\Lambda}_F={I}_n=\frac{I_1}{F_n}\approx \frac{\sqrt{5}}{K^{n+1}}{I}_1 $$](img/500382_1_En_9_Chapter_TeX_Equq.png)

对于黄金分割搜索，如下:

![$$ {\Lambda}_G={I}_n=\frac{I_1}{K^{n+1}} $$](img/500382_1_En_9_Chapter_TeX_Equr.png)

于是，我们有了下面的:

![$$ \frac{\Lambda_G}{\Lambda_F}=\frac{K^2}{\sqrt{5}}=1.17 $$](img/500382_1_En_9_Chapter_TeX_Equs.png)
...
![$$ p(x)={a}_0+{a}_1x+{a}_2{x}^2 $$](img/500382_1_En_9_Chapter_TeX_Equt.png)

有了这三点，我们就可以通过求解三个线性方程组来确定多项式系数。*p*(*x*)![$$ \overline{x} $$](img/500382_1_En_9_Chapter_TeX_IEq2.png)的最小值可以通过求解其一阶导数等于零来容易地确定。

![$$ \overline{x}=-\frac{a_1}{2{a}_2} $$](img/500382_1_En_9_Chapter_TeX_Equu.png)

借助泰勒展开，![$$ \overline{x} $$](img/500382_1_En_9_Chapter_TeX_IEq3.png)将充分接近*x*<sup>√</sup>；事实上，如果函数是二次的，它将是精确的。通过检查![$$ \overline{x} $$](img/500382_1_En_9_Chapter_TeX_IEq4.png)，我们可以通过拒绝 *x* <sub>* L *</sub> 或 *x* <sub>* U *</sub> 并保留![$$ \overline{x} $$](img/500382_1_En_9_Chapter_TeX_IEq5.png)来选择新的间隔。重复该过程，直到所有三个点足够接近(到*x*T21】∫)。见图 [9-5](img/#Fig5) 。

![img/500382_1_En_9_Fig5_HTML.png](img/500382_1_En_9_Fig5_HTML.png)
...
![img/500382_1_En_9_Fig6_HTML.jpg](img/500382_1_En_9_Fig6_HTML.jpg)
...
![$$ \min F=f(x)\kern0.75em for\ x\in {E}^n $$](img/500382_1_En_9_Chapter_TeX_Equv.png)
...
![img/500382_1_En_9_Fig7_HTML.jpg](img/500382_1_En_9_Fig7_HTML.jpg)
...
![$$ f\left({x}_1,{x}_2,{x}_3,{x}_4\right)={\left({x}_1-4{x}_2\right)}^4+12{\left({x}_3-{x}_4\right)}^4+3{\left({x}_2-10{x}_3\right)}^2+55{\left({x}_1-2{x}_4\right)}^2 $$](img/500382_1_En_9_Chapter_TeX_Equx.png)
...
**![$$ f\left(x+\delta \right)\approx f(x)+\sum \limits_{j=1}^n\frac{\partial f}{\partial {x}_i}{\delta}_i+\frac{1}{2}\sum \limits_{i=1}^n\sum \limits_{j=1}^n\frac{\partial^2f}{\partial {x}_i\partial {x}_j}{\delta}_i{\delta}_j $$](img/500382_1_En_9_Chapter_TeX_Equy.png)**

 **区分*f*(***x***+***δ***)相对于 *δ* <sub>*k*</sub> 为了最小化*f*(***x***+***δ**【T25)，我们有如下:*

*![$$ \frac{\partial f}{\partial {x}_k}+\sum \limits_{i=1}^n\frac{\partial^2f}{\partial {x}_i\partial {x}_j}{\delta}_i=0\kern0.75em for\ k=1,2,\dots, n $$](img/500382_1_En_9_Chapter_TeX_Equz.png)*

用矩阵形式改写如下:

![$$ g=-\boldsymbol{H}\delta $$](img/500382_1_En_9_Chapter_TeX_Equaa.png)

***x*** 中的最优变化如下:

![$$ \delta =-{\boldsymbol{H}}^{-\mathbf{1}}g $$](img/500382_1_En_9_Chapter_TeX_Equab.png)

使用线搜索来计算沿着方向的 *f* ( ***x*** )的最大减少量。下一点***x***<sub>***k+1***</sub>如下:

![$$ {x}_{k+1}={x}_k+{\delta}_k={x}_k+{\alpha}_k{d}_k $$](img/500382_1_En_9_Chapter_TeX_Equac.png)

以下哪一项是正确的:

![$$ {d}_k=-{\boldsymbol{H}}_k^{-1}{g}_k $$](img/500382_1_En_9_Chapter_TeX_Equad.png)
...
![$$ \boldsymbol{f}={\left[{f}_1(x)\kern0.5em {f}_2(x)\dots \dots \kern0.5em {f}_m(x)\right]}^T $$](img/500382_1_En_9_Chapter_TeX_Equae.png)

解决方法是一个点***×点**×点*使得所有的*f*<sub>*p*</sub>(***×点*** )同时归零。

我们可以构造一个实值函数 *F* ，使得如果 *F* 被最小化，那么函数*F*<sub>*p*</sub>(***x***)在最小二乘意义上也被最小化。

![$$ F=\sum \limits_{p=1}^m{f}_p{(x)}^2=\boldsymbol{f}{\boldsymbol{f}}^{\boldsymbol{T}} $$](img/500382_1_En_9_Chapter_TeX_Equaf.png)

梯度的雅可比矩阵如下:

![$$ \mathbf{J}=\left[\begin{array}{ccc}\frac{\partial {f}_1}{\partial {x}_1}&amp; \cdots &amp; \frac{\partial {f}_m}{\partial {x}_1}\\ {}\vdots &amp; \ddots &amp; \vdots \\ {}\frac{\partial {f}_1}{\partial {x}_n}&amp; \cdots &amp; \frac{\partial {f}_m}{\partial {x}_n}\end{array}\right] $$](img/500382_1_En_9_Chapter_TeX_Equag.png)

区分 *F* 关于*x*<sub>T5】I</sub>，我们有如下:

![$$ \frac{\partial F}{\partial {x}_i}=\sum \limits_{p=1}^m2{f}_p(x)\frac{\partial {f}_p}{\partial {x}_i} $$](img/500382_1_En_9_Chapter_TeX_Equah.png)

或者，在矩阵形式中，我们有这样的:

![$$ {g}_F=2{\mathbf{J}}^{\boldsymbol{T}}f $$](img/500382_1_En_9_Chapter_TeX_Equai.png)

再区分一下，我们有以下:

![$$ \frac{\partial^2F}{\partial {x}_i\partial {x}_j}\approx 2\sum \limits_{p=1}^m\frac{\partial {f}_p}{\partial {x}_i}\frac{\partial {f}_p}{\partial {x}_j} $$](img/500382_1_En_9_Chapter_TeX_Equaj.png)

黑森**H**<sub>T3】FT5 如下。它必须是非奇异和正定的。</sub>

![$$ {\mathbf{H}}_F\approx 2{\mathbf{J}}^{\boldsymbol{T}}\mathbf{J} $$](img/500382_1_En_9_Chapter_TeX_Equak.png)

下一个点是由递归关系给出的:

![$$ {x}_{k+1}={x}_k-{\alpha}_k{\left(2{\mathbf{J}}^{\boldsymbol{T}}\mathbf{J}\right)}^{-1}\left(2{\mathbf{J}}^{\boldsymbol{T}}\mathbf{f}\right) $$](img/500382_1_En_9_Chapter_TeX_Equal.png)
...
![$$ \min {\boldsymbol{x}}^{\boldsymbol{T}}\mathbf{b}+\frac{1}{2}{\mathbf{x}}^{\boldsymbol{T}}\boldsymbol{H}\mathbf{X} $$](img/500382_1_En_9_Chapter_TeX_Equam.png)
...
![$$ \boldsymbol{H}{\mathbf{x}}^{\ast}=\mathbf{b} $$](img/500382_1_En_9_Chapter_TeX_Equan.png)

因为共轭向量组是线性独立的，因此跨越了 *n* 维空间*E*<sup>T5】n</sup>，***x***<sup>***∑***</sup>可以写成这些向量的线性组合。

![$$ {\boldsymbol{x}}^{\ast }={\alpha}_0{\boldsymbol{d}}_{\mathbf{0}}+\dots +{\alpha}_{n-1}{\boldsymbol{d}}_{\boldsymbol{n}-\mathbf{1}} $$](img/500382_1_En_9_Chapter_TeX_Equao.png)

两边乘以 ***H*** 并取与**<sub>**I**</sub>的标量积得出:**

**![$$ {\alpha}_i=-\frac{{\boldsymbol{d}}_{\boldsymbol{i}}^{\boldsymbol{T}}\boldsymbol{H}{\boldsymbol{x}}^{\ast }}{{\boldsymbol{d}}_{\boldsymbol{i}}^{\boldsymbol{T}}\boldsymbol{H}{\boldsymbol{d}}_{\boldsymbol{i}}}=-\frac{{\boldsymbol{d}}_{\boldsymbol{i}}^{\boldsymbol{T}}\boldsymbol{b}}{{\boldsymbol{d}}_{\boldsymbol{i}}^{\boldsymbol{T}}\boldsymbol{H}{\boldsymbol{d}}_{\boldsymbol{i}}} $$](img/500382_1_En_9_Chapter_TeX_Equap.png)**

 **或者等价地，

![$$ {\boldsymbol{x}}^{\ast }=\sum \limits_{\boldsymbol{i}=\mathbf{0}}^{\boldsymbol{n}-\mathbf{1}}\frac{{\boldsymbol{d}}_{\boldsymbol{i}}^{\boldsymbol{T}}\boldsymbol{b}}{{\boldsymbol{d}}_{\boldsymbol{i}}^{\boldsymbol{T}}\boldsymbol{H}{\boldsymbol{d}}_{\boldsymbol{i}}}{\boldsymbol{d}}_{\boldsymbol{i}} $$](img/500382_1_En_9_Chapter_TeX_Equaq.png)

这种***x***<sup>***∫***</sup>的展开，可以认为是一个求和或者一个*n*-相加*α*<sub>*I*</sub>***d***<sub>***I***</sub>的分步迭代过程。

**共轭方向定理**

设![$$ {\left\{{\boldsymbol{d}}_{\boldsymbol{i}}\right\}}_{i=0}^{n-1} $$](img/500382_1_En_9_Chapter_TeX_IEq7.png)为一组非零的***H***T5】-正交向量。对于任意一个***x***<sub>0</sub>∈*E*<sup>*n*</sup>，序列{***×x***<sub>*I*</sub>}按照以下方式生成:

![$$ {\boldsymbol{x}}_{\boldsymbol{k}+\mathbf{1}}={\boldsymbol{x}}_{\boldsymbol{k}}+{\alpha}_k{\boldsymbol{d}}_{\boldsymbol{k}},k\ge 0 $$](img/500382_1_En_9_Chapter_TeX_Equar.png)

同下面:

![$$ {\alpha}_k=-\frac{{\boldsymbol{g}}_{\boldsymbol{k}}^{\boldsymbol{T}}{\boldsymbol{d}}_{\boldsymbol{k}}}{{\boldsymbol{d}}_{\boldsymbol{k}}^{\boldsymbol{T}}\boldsymbol{H}{\boldsymbol{d}}_{\boldsymbol{k}}} $$](img/500382_1_En_9_Chapter_TeX_Equas.png)

还有下面的:

![$$ {\boldsymbol{g}}_{\boldsymbol{k}}=\boldsymbol{b}+\boldsymbol{H}{\boldsymbol{x}}_{\boldsymbol{k}} $$](img/500382_1_En_9_Chapter_TeX_Equat.png)
...
![$$ {\boldsymbol{d}}_{\mathbf{0}}=-{\boldsymbol{g}}_{\mathbf{0}}=-\left(\boldsymbol{b}+\boldsymbol{H}{\boldsymbol{x}}_{\mathbf{0}}\right) $$](img/500382_1_En_9_Chapter_TeX_Equau.png)

![$$ {\boldsymbol{d}}_{\boldsymbol{k}}=-{\boldsymbol{g}}_{\boldsymbol{k}}+{\beta}_k{\boldsymbol{d}}_{\boldsymbol{k}-\mathbf{1}} $$](img/500382_1_En_9_Chapter_TeX_Equav.png)

![$$ {\boldsymbol{g}}_{\boldsymbol{k}}=\boldsymbol{b}+\boldsymbol{H}{\boldsymbol{x}}_{\boldsymbol{k}} $$](img/500382_1_En_9_Chapter_TeX_Equaw.png)

![$$ {\beta}_k=\frac{{\boldsymbol{g}}_k^TH{d}_k}{{\boldsymbol{d}}_k^TH{d}_k} $$](img/500382_1_En_9_Chapter_TeX_Equax.png)

![$$ {\alpha}_k=-\frac{{\boldsymbol{g}}_k^T{d}_k}{{\boldsymbol{d}}_k^TH{d}_k} $$](img/500382_1_En_9_Chapter_TeX_Equay.png)
...
设![$$ {x}_a^{\ast } $$](img/500382_1_En_9_Chapter_TeX_IEq8.png)和![$$ {x}_b^{\ast } $$](img/500382_1_En_9_Chapter_TeX_IEq9.png)为若下列凸二次函数得到的极小值:

![$$ f(x)={x}^Tb+\frac{1}{2}{x}^T\boldsymbol{H}x $$](img/500382_1_En_9_Chapter_TeX_Equaz.png)

相对于行 ***上的*α*d***<sub>***a***</sub>和***d***<sub>***b***</sub>:

![$$ x={x}_a+\alpha {\boldsymbol{d}}_{\boldsymbol{a}} $$](img/500382_1_En_9_Chapter_TeX_Equba.png)

还有下面的:

![$$ x={x}_b+\alpha {\boldsymbol{d}}_{\boldsymbol{b}} $$](img/500382_1_En_9_Chapter_TeX_Equbb.png)

如果说***d***<sub>***a***</sub>**=*****d***<sub>***b***</sub>，那么矢量![$$ {x}_b^{\ast }-{x}_a^{\ast } $$](img/500382_1_En_9_Chapter_TeX_IEq10.png)相对于***d***<sub>***a***</sub>。参见图 [9-8](img/#Fig8) 。

![img/500382_1_En_9_Fig8_HTML.jpg](img/500382_1_En_9_Fig8_HTML.jpg)
...
***![$$ {\boldsymbol{d}}_{0\left(n+1\right)}={x}_{0n}-{x}_{00} $$](img/500382_1_En_9_Chapter_TeX_Equbc.png)***

 **并且 *f* ( ***x*** )在这个方向上被最小化以产生新的点***x***<sub>0(*n*+1)</sub>。通过设置以下内容更新方向(参见图[9-9](#Fig9)):

![$$ {\boldsymbol{d}}_{11}={\boldsymbol{d}}_{02} $$](img/500382_1_En_9_Chapter_TeX_Equbd.png)

![$$ {\boldsymbol{d}}_{12}={\boldsymbol{d}}_{03} $$](img/500382_1_En_9_Chapter_TeX_Eqube.png)

![$$ \cdots $$](img/500382_1_En_9_Chapter_TeX_Equbf.png)

![$$ {\boldsymbol{d}}_{1\left(n-1\right)}={\boldsymbol{d}}_{0n} $$](img/500382_1_En_9_Chapter_TeX_Equbg.png)

![$$ {\boldsymbol{d}}_{1n}={\boldsymbol{d}}_{0\left(n+1\right)} $$](img/500382_1_En_9_Chapter_TeX_Equbh.png)

![img/500382_1_En_9_Fig9_HTML.jpg](img/500382_1_En_9_Fig9_HTML.jpg)
...
![$$ {\boldsymbol{d}}_{1\left(n+1\right)}={x}_{1n}-{x}_{10} $$](img/500382_1_En_9_Chapter_TeX_Equbi.png)

![img/500382_1_En_9_Fig10_HTML.jpg](img/500382_1_En_9_Fig10_HTML.jpg)
...
![$$ f\left({x}_1,{x}_2\right)={\left({x_1}^2+{x}_2-11\right)}^2+{\left({x}_1+{x_2}^2-7\right)}^2 $$](img/500382_1_En_9_Chapter_TeX_Equbj.png)

![img/500382_1_En_9_Fig11_HTML.jpg](img/500382_1_En_9_Fig11_HTML.jpg)
...
![$$ {x}_{k+1}={x}_k-{\alpha}_k{\boldsymbol{S}}_{\boldsymbol{k}}{g}_k $$](img/500382_1_En_9_Chapter_TeX_Equbk.png)
...
![$$ {\delta}_k={x}_{k+1}-{x}_k $$](img/500382_1_En_9_Chapter_TeX_Equbl.png)

逐次梯度的区别 *g* <sub>*k*</sub> 如下:

![$$ {\gamma}_k={g}_{k+1}-{g}_k $$](img/500382_1_En_9_Chapter_TeX_Equbm.png)

于是我们有了这个:

![$$ {\gamma}_k=\boldsymbol{H}{\delta}_k $$](img/500382_1_En_9_Chapter_TeX_Equbn.png)

牛顿法确定方向向量如下:

![$$ {d}_k=-{\boldsymbol{S}}_{\boldsymbol{k}}{g}_k $$](img/500382_1_En_9_Chapter_TeX_Equbo.png)

幅度 *α* <sub>*k*</sub> 可以通过最小化函数

![$$ f\left({x}_k+\alpha {d}_k\right) $$](img/500382_1_En_9_Chapter_TeX_Equbp.png)

的线搜索来确定

我们要避免对一个矩阵求逆，比如计算***S***<sub>***k***</sub>**= H**<sup>—1</sup>并检查***S***<sub>***k***</sub>在每次迭代中都是正定的。我们要一个简单的更新规则为***S***<sub>***k+*****1**</sub>。

![$$ {\boldsymbol{S}}_{\boldsymbol{k}+\mathbf{1}}={\boldsymbol{S}}_{\boldsymbol{k}}+{\boldsymbol{C}}_{\boldsymbol{k}} $$](img/500382_1_En_9_Chapter_TeX_Equbq.png)T38】
...
![$$ {\mathbf{S}}_{\boldsymbol{k}+\mathbf{1}}{\gamma}_k={\delta}_k $$](img/500382_1_En_9_Chapter_TeX_Equbr.png)

让

![$$ {\mathbf{S}}_{\boldsymbol{k}+\mathbf{1}}={\mathbf{S}}_{\boldsymbol{k}}+\beta {\xi}_k{\xi}_k^T $$](img/500382_1_En_9_Chapter_TeX_Equbs.png)

***ξ***<sub>***k***</sub>为列向量， *β* <sub>*k*</sub> 为常数。校正矩阵![$$ \beta {\xi}_k{\xi}_k^T $$](img/500382_1_En_9_Chapter_TeX_IEq11.png)是对称的，并且秩为 1。结合这两个等式，我们得到如下:

![$$ {\delta}_k={\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k+\beta {\xi}_k{\xi}_k^T{\gamma}_k $$](img/500382_1_En_9_Chapter_TeX_Equbt.png)

而我们有以下:

![$$ {\gamma}_k^T\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right)={\beta}_k{\gamma}_k^T{\xi}_k{\xi}_k^T{\gamma}_k={\beta}_k{\left({\xi}_k^T{\gamma}_k\right)}^2 $$](img/500382_1_En_9_Chapter_TeX_Equbu.png)

![$$ \left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right){\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right)}^T={\beta}_k{\left({\xi}_k^T{\gamma}_k\right)}^2{\beta}_k{\xi}_k{\xi}_k^T $$](img/500382_1_En_9_Chapter_TeX_Equbv.png)

于是我们有了以下:

![$$ {\beta}_k{\xi}_k{\xi}_k^T=\frac{\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right){\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right)}^T}{\gamma_k^T\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right)} $$](img/500382_1_En_9_Chapter_TeX_Equbw.png)

因此，我们有以下:

![$$ {\mathbf{S}}_{\boldsymbol{k}+\mathbf{1}}={\mathbf{S}}_{\boldsymbol{k}}+\frac{\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right){\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right)}^T}{\gamma_k^T\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right)} $$](img/500382_1_En_9_Chapter_TeX_Equbx.png)
...
![$$ {\mathbf{S}}_{\boldsymbol{k}+\mathbf{1}}={\mathbf{S}}_{\boldsymbol{k}}+\frac{\delta_k{\delta}_k^T}{\delta_k^T{\gamma}_k}-\frac{{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k{\gamma}_k^T{\mathbf{S}}_{\boldsymbol{k}}}{\gamma_k^T{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k} $$](img/500382_1_En_9_Chapter_TeX_Equby.png)
...
4.  ![$$ {\delta}_k^T{\gamma}_k={\delta}_k^T{g}_{k+1}-{\delta}_k^T{g}_k&gt;0 $$](img/500382_1_En_9_Chapter_TeX_IEq12.png)。
...
通过让![$$ \frac{\phi }{\theta }=\frac{-{\gamma}_k{\delta}_k^T}{\gamma_k{\delta}_k^T+{\gamma}_k^T{S}_k{\gamma}_k},\psi =1,\mathrm{and}\ \omega =0 $$](img/500382_1_En_9_Chapter_TeX_IEq13.png)我们有了 BFGS 公式。

设 *θ* = 1， *ϕ* = 0， *ψ* = 1， *ω* = 0，我们就有了麦考密克公式。

![$$ {\mathbf{S}}_{\boldsymbol{k}+\mathbf{1}}={\mathbf{S}}_{\boldsymbol{k}}+\frac{\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right){\delta}_k^T}{\delta_k^T{\gamma}_k} $$](img/500382_1_En_9_Chapter_TeX_Equcb.png)

设 *θ* = 0， *ϕ* = 1， *ψ* = 0， *ω* = 1，我们就有了皮尔逊公式。

![$$ {\mathbf{S}}_{\boldsymbol{k}+\mathbf{1}}={\mathbf{S}}_{\boldsymbol{k}}+\frac{\left({\delta}_k-{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k\right){\gamma}_k^T{\mathbf{S}}_{\boldsymbol{k}}}{\gamma_k^T{\mathbf{S}}_{\boldsymbol{k}}{\gamma}_k} $$](img/500382_1_En_9_Chapter_TeX_Equcc.png)
