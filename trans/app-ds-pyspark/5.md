...
| 伪 Huber 损失 | x = &#124; y–y-hat &#124;![$$ \left\{\begin{array}{c}{\left(y-y- hat\right)}^2; when\ x\le \alpha \\ {}\mid y-y- hat\mid; otherwise\kern1.5em \end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq1.png) | 结合了平方误差和绝对误差损失。调整超参数 *α* 以获得最佳结果。 |
| 分类 | 二元交叉熵损失 | -(y log(p) + (1-y) log(1-p)) | 二元目标。默认损失函数。 |
| 分类交叉熵损失 | C -类别数![$$ \hbox{--} \sum \limits_{x\in C}p(x)\ \mathit{\log}\ q(x) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq2.png) | 多项目标。默认损失函数。 |
| KL 发散损失 | C -类别数![$$ \hbox{--} \sum \limits_{x\in C}p(x)\ \mathit{\log}\ \left(\frac{q(x)}{p(x)}\right) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq3.png) | 多项目标*注:交叉熵=熵+ KL 散度* |
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig1_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig1_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig2_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig2_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig3_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig3_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig4_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig4_HTML.jpg)
...
![$$ {\beta}_i={\beta}_i-\alpha \ast {\mathrm{Slope}}_i $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equa.png)

![$$ {\beta}_{\mathrm{i}}=\mathrm{Model}\ \mathrm{parameter}\ \mathrm{of}\ \mathrm{a}\ \mathrm{variable}\ i $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equb.png)

![$$ \alpha =\mathrm{Learning}\ \mathrm{rate} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equc.png)
...
![$$ {\mathrm{Slope}}_i=\mathrm{Gradient}\ \mathrm{or}\ \mathrm{slope}\ \mathrm{with}\ \mathrm{respect}\ \mathrm{to}\ \mathrm{the}\ \mathrm{variable}\ i=\frac{\partial }{\partial {\beta}_i} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq4.png)错误
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig5_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig5_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig6_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig6_HTML.jpg)
...
我们先来看看动量优化器的方程式，然后再谈细节(图 [5-7](#Fig7) )。【T2![$$ {\beta}_i={\beta}_i-\alpha \ast {\mathrm{Slope}}_i(t)+m= GD+m $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equd.png)

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig7_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig7_HTML.jpg)
...
![$$ {\beta}_{\mathrm{i}}={\beta}_{\mathrm{i}}-\frac{\propto }{\sqrt{{\mathrm{G}}_{\mathrm{i}}(t)}+\varepsilon}\ast {\mathrm{Slope}}_{\mathrm{i}}(t) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Eque.png)

而 G <sub>i</sub> 则由

![$$ {\mathrm{G}}_{\mathrm{i}}(t)={\mathrm{G}}_{\mathrm{i}}\left(t-1\right)+{\left({\mathrm{Slope}}_{\mathrm{i}}(t)\right)}^2 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equf.png)
...
![$$ {\beta}_{\mathrm{i}}={\beta}_{\mathrm{i}}-\frac{\propto }{\sqrt{{\mathrm{G}}_{\mathrm{i}}(t)}+\varepsilon}\ast {\mathrm{Slope}}_{\mathrm{i}}(t) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equg.png)

更新规则还是一样的。但是，在 G <sub>i</sub> 参数中引入了变化，如下:

![$$ {\mathrm{G}}_{\mathrm{i}}(t)=\upgamma {\mathrm{G}}_{\mathrm{i}}\left(t-1\right)+\left(1-\upgamma \right){\left({\mathrm{Slope}}_{\mathrm{i}}(t)\right)}^2 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equh.png)
...
![$$ {\beta}_{\mathrm{i}}={\beta}_{\mathrm{i}}-\frac{\propto }{\sqrt{{\mathrm{G}}_{\mathrm{i}}(t)}+\varepsilon}\ast {\mathrm{m}}_{\mathrm{i}}(t) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equi.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig8_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig8_HTML.jpg)
...
![$$ f(x)=x $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equj.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig9_HTML.png](img/500182_1_En_5_Chapter/500182_1_En_5_Fig9_HTML.png)
...
![$$ f(x)=\frac{1}{1+\mathit{\exp}\left(-x\right)} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equk.png)

我们可以使用自定义的截止值将 *f* ( *x* )值转换为开/关信号，如下:

![$$ \left\{\begin{array}{c}1\ for\ f(x)\ge cut- off\ \\ {}0\ for\ f(x)&lt; cut- off\end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equl.png)

当涉及到二进制分类时，大多数算法使用 0.5 作为截止值。你可以根据你的锻炼来调整它。这个函数的导数是

![$$ {f}^{\prime }(x)=f(x)\left(1-f(x)\right) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equm.png)

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig10_HTML.png](img/500182_1_En_5_Chapter/500182_1_En_5_Fig10_HTML.png)
...
![$$ f(x)=\mathit{\tanh}(x)=\left(\frac{2}{1+\mathit{\exp}\left(-2x\right)}\right)-1 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equn.png)

与 Sigmoid 函数类似，您可以使用自定义截止值(默认为 0)将输出转换为 0/1 二进制输出。这个函数的导数是

![$$ {f}^{\prime }(x)=1-f{(x)}^2 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equo.png)

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig11_HTML.png](img/500182_1_En_5_Chapter/500182_1_En_5_Fig11_HTML.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig12_HTML.png](img/500182_1_En_5_Chapter/500182_1_En_5_Fig12_HTML.png)
...
![$$ f(x)=\left\{\begin{array}{c}x\ for\ x\ge 0\\ {}0\ for\ x&lt;0\end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equp.png)

这个函数的导数是

![$$ {f}^{\prime }(x)=\left\{\begin{array}{c}1\ for\ x\ge 0\\ {}0\ for\ x&lt;0\end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equq.png)

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig13_HTML.png](img/500182_1_En_5_Chapter/500182_1_En_5_Fig13_HTML.png)
...
![$$ f(x)=\left\{\begin{array}{c}x\ for\ x\ge 0\\ {}\alpha x\ for\ x&lt;0\end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equr.png)

这个函数的导数是

![$$ {f}^{\prime }(x)=\left\{\begin{array}{c}1\ for\ x\ge 0\\ {}\alpha\ for\ x&lt;0\end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equs.png)
...
![$$ f(x)=x\ast sigmoid(x)=x\ast \left(\frac{1}{1+\mathit{\exp}\left(-x\right)}\right) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equt.png)

这个函数的导数由

![$$ {f}^{\prime }(x)=f(x)+ sigmoid(x)\ast \left(1-f(x)\right) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equu.png)

给出

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig14_HTML.png](img/500182_1_En_5_Chapter/500182_1_En_5_Fig14_HTML.png)
...
![$$ f(x)=\frac{e^{Xi}}{\sum \limits_j{e}^{Xj}} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equv.png)

当类别数为 3，且 *x* 值为[5，4，3]时， *f* ( *x* )计算为

![$$ f(5)=\frac{e^5}{e^5+{e}^4+{e}^3}=0.665 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equw.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig15_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig15_HTML.jpg)
...
![$$ y={\beta}_0+{\beta}_1\ast {x}_1+{\beta}_2\ast {x}_2+\kern0.5em \dots \dots \dots +{\beta}_n\ast {x}_n $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equx.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig16_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig16_HTML.jpg)
...
![$$ VIF=\frac{1}{1-{R}^2} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equy.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig17_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig17_HTML.jpg)
...
![$$ \mathit{\log}\left(\frac{p}{1-p}\right)={\beta}_0+{\beta}_1\ast {x}_1+{\beta}_2\ast {x}_2+\kern0.5em \dots \dots \dots +{\beta}_n\ast {x}_n $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equz.png)

逻辑回归的方程不同于左边部分的线性回归方程。这个分量![$$ \mathit{\log}\left(\frac{p}{1-p}\right) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq5.png)，被称为 *log(odds)* 。为什么 *log(赔率)*？请看图 [5-18](img/#Fig18) 。

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig18_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig18_HTML.jpg)
...
![$$ \mathit{\log}\left(\frac{p}{1-p}\right)=\mathit{\log}(odds) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equaa.png)

![img/500182_1_En_5_Chapter/500182_1_En_5_Fig19_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig19_HTML.jpg)
...
![$$ \frac{p}{1-p}={e}^{\mathit{\log}(odds)} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equab.png)这个意思是

解这个方程，我们得到

![$$ p=\frac{e^{\mathit{\log}(odds)}}{1+{e}^{\mathit{\log}(odds)}}=\frac{1}{1+{e}^{-\mathit{\log}(odds)}}=\frac{1}{1+{e}^{-x}}\kern0.5em = sigmoid\ function $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equac.png)
...
![$$ p(x)=\frac{e^{\mathit{\log}(odds)}}{1+{e}^{\mathit{\log}(odds)}}=\frac{e^x}{e^0+{e}^x} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equad.png)

这里， *e* <sup>0</sup> 对应于基线模型，是二进制结果中的 0 类。 *e* <sup>*x*</sup> 对应于 1 类。以类似的方式，我们可以将相同的公式应用于多类问题。假设您有类 *a* 、 *b* 和 *c* 。每一类的概率由

![$$ p(a)=\frac{e^{\mathit{\log}(odds)}}{1+{e}^{\mathit{\log}(odds)}}=\frac{e^a}{e^a+{e}^b+{e}^c} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equae.png)

给出

对于其他类，相应的 *e* 元素将被放入分子中。如前所述，这就是 SoftMax 函数。现在，你知道了 Sigmoid 和 SoftMax 之间的联系。二进制和多类的另一个需要考虑的是链接函数。一般来说，我们对二元目标使用 logit ( ![$$ \mathit{\log}\left(\frac{p}{1-p}\right)\Big) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq6.png)链接函数。对于多项式，您可以对名义目标使用 probit，对顺序目标使用 clog-log。在 PySpark 中，您可以通过设置逻辑回归算法中的*族*选项来完成二元或多项式拟合。

#### PySpark 代码

在这个练习中，目标变量是银行数据集中的 *y* ，输入预测值是*年龄、余额、天数、持续时间、活动、天数、前一天。*目标 *y* 是二进制类*。*

![img/500182_1_En_5_Chapter/500182_1_En_5_Figa_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Figa_HTML.jpg)
...
Log( ![$$ \frac{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Female}}{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Male}}\Big) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq7.png) = 0.16

![$$ \frac{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Female}}{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Male}}={e}^{0.16}=1.173 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equaf.png)
...
Log( ![$$ \frac{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Age}=30}{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Age}=29}\Big) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq8.png) = -0.32

![$$ \frac{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Age}=30}{\mathrm{odds}\ \mathrm{class}\ 1\mid \mathrm{Age}=29}={\mathrm{e}}^{-0.32}=0.73 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equag.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig20_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig20_HTML.jpg)
...
![$$ Entropy=-\sum p(x)\ {\mathit{\log}}_2p(x) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equah.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig21_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig21_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig22_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig22_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig23_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig23_HTML.jpg)
...
![$$ Gini=1-\sum {\left(p(x)\right)}^2 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equai.png)
...
![$$ Variance=\frac{\sum {\left(X- mean(X)\right)}^2}{n} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equaj.png)
...
![$$ {f}_i=\sum \limits_{j: nodes\ splits\ on\ feature\ i}{s}_j\ast {G}_j $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equak.png)T2】

其中

![$$ {f}_i=\mathrm{importance}\ \mathrm{of}\ \mathrm{feature} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equal.png)

![$$ {s}_j=\mathrm{number}\ \mathrm{of}\ \mathrm{samples}\ \mathrm{in}\ \mathrm{node}\ j $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equam.png)

![$$ {G}_j=\mathrm{impurity}\ \mathrm{value}\ \mathrm{of}\ \mathrm{node}\ j $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equan.png)
...
![$$ \mathrm{final}-{f}_i=\frac{f_i\ }{f_1+{f}_2+\dots \dots +{f}_n} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equao.png)

给出

其中

![$$ {f}_1,{f}_2,..\dots, {f}_n\ \mathrm{are}\ \mathrm{the}\ \mathrm{individual}\ \mathrm{feature}\ \mathrm{importance}\ \mathrm{of}\ \mathrm{each}\ \mathrm{variable} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equap.png)

![$$ {f}_i-\mathrm{feature}\ \mathrm{imporatance}\ \mathrm{of}\ \mathrm{the}\ {i}^{th}\ \mathrm{variable}\ \mathrm{calculated}\ \mathrm{using}\ \mathrm{the}\ \mathrm{previous}\ \mathrm{equation} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equaq.png)

![$$ \mathrm{final}-{f}_i-\kern0.5em \mathrm{normalized}\ \mathrm{feature}\ \mathrm{importance}\ \mathrm{of}\ \mathrm{variable}\ i $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equar.png)
...
![$$ \mathrm{average}-{f}_i=\frac{f_i\ }{\mathrm{number}\ \mathrm{of}\ \mathrm{trees}\ \mathrm{with}\ \mathrm{feature}\ {f}_i\ } $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equas.png)T2】
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig24_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig24_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig25_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig25_HTML.jpg)
...
![$$ ax+ by+c=---&gt; center\ line $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equat.png)

![$$ ax+ by+c=i---&gt; upper\ margin $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equau.png)

![$$ ax+ by+c=-i---&gt; lower\ margin $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equav.png)

我们可以用下面的公式计算页边距的宽度:

![$$ W=\frac{2i}{\sqrt{a^2+{b}^2}} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equaw.png)

并且裕度误差由下式给出:

![$$ Margin\ error={a}^2+{b}^2 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equax.png)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig26_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig26_HTML.jpg)
...
![img/500182_1_En_5_Chapter/500182_1_En_5_Fig27_HTML.jpg](img/500182_1_En_5_Chapter/500182_1_En_5_Fig27_HTML.jpg)
...
![$$ \mathrm{Sigmoid}\ \mathrm{function},\upsigma =\frac{1}{1+\mathit{\exp}\left(-x\right)} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equay.png)

![$$ final\ output=\left\{\begin{array}{c}0\ if\ \upsigma &lt;0.5\\ {}1\ if\ \upsigma \ge 0.5\end{array}\right. $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equaz.png)
...
![$$ \frac{\mathbf{1}}{\mathbf{1}+\boldsymbol{\exp}\left(-\boldsymbol{output}\right)} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq9.png)
...
![$$ \mathrm{Derivation}\ \mathrm{of}\ \mathrm{Sigmoid}\ \mathrm{function},{\upsigma}^{\prime }=\upsigma \ast \left(1-\upsigma \right) $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equba.png)
...
![$$ P\left(A|B\right)=\frac{P\left(B|A\right)\ast P(A)}{P(B)} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equbb.png)
...
*   ![$$ P\left( Greenball\ |\ Bucket2\right)=P\left(B|A\right)=0.7 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equbc.png)
...
P( *水桶* 2| *绿球*)= P(A | B)=![$$ \frac{\mathrm{P}\left(\mathrm{B}|\mathrm{A}\right)\ast \mathrm{P}\left(\mathrm{A}\right)}{\mathrm{P}\left(\mathrm{B}\right)} $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_IEq10.png)=(0.7 * 0.5)/0.5 = 0.7
...
![$$ \alpha \left(\ \lambda\ {\left\Vert w\right\Vert}_1\right)+\left(1-\alpha \right)\ \left(\frac{\lambda }{2}\ {\left\Vert w\right\Vert}_2^2\right),\alpha \in \left[0,1\right],\lambda \ge 0 $$](img/500182_1_En_5_Chapter/500182_1_En_5_Chapter_TeX_Equbd.png)
