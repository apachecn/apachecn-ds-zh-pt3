...
在第**章** [**9**](09.html) 中，我们看到了如何将我们的micro:bit气象站连接到物联网平台，以增强我们的数据科学工具包。在第**章** [**10**](10.html) 中，我们考虑了 AI/ML 可以给我们的数据科学实验带来的潜在价值，它如何将我们从过程的元素中解放出来，并允许我们最大限度地利用时间来锻炼我们的好奇心和直觉——这是不可替代的人类特征，是数据科学的真正大脑。
