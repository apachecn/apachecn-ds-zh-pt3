...
在哪里找到/如何创建参数
 ...
 |
| --- | --- |
| 要连接物联网平台，需要设置**客户端 ID** 值。 | ![img/486852_1_En_9_Figa_HTML.jpg](img/486852_1_En_9_Figa_HTML.jpg)客户端 ID 由 3 个参数组成，您需要以一种非常特殊的格式将它们连接在一起(" **concatenate** ")。您需要的参数是组织 ID设备类型设备 ID格式是***d:组织标识:设备类型:设备标识**T3】*当您正确地连接数据后，它应该看起来像这样:**d：奥普拉 53：中国包装：xb123456** |
