...
![$$ \mathit{\min}\kern0.5em \sum \limits_p\sum \limits_m{c}_{p,m}\ast {x}_{p,m} $$](img/477168_1_En_10_Chapter/477168_1_En_10_Chapter_TeX_Equa.png)

服从于:

![$$ \sum \limits_m{x}_{p,m}\le {a}_p $$](img/477168_1_En_10_Chapter/477168_1_En_10_Chapter_TeX_Equb.png)

![$$ \sum \limits_p{x}_{p,m}\ge {b}_m $$](img/477168_1_En_10_Chapter/477168_1_En_10_Chapter_TeX_Equc.png)
...
![img/477168_1_En_10_Chapter/477168_1_En_10_Figa_HTML.gif](img/477168_1_En_10_Chapter/477168_1_En_10_Figa_HTML.gif)`GLPK.jl`和`Ipopt.jl`包都将自动安装必要的二进制文件供自己使用(除非您指示它们使用本地安装的二进制文件，在安装或构建包之前设置`ENV["JULIA_GLPK_LIBRARY_PATH"], ENV["JULIA_IPOPT_LIBRARY_PATH"]`和`ENV["JULIA_IPOPT_EXECUTABLE_PATH"]`)。
...
![img/477168_1_En_10_Chapter/477168_1_En_10_Figb_HTML.gif](img/477168_1_En_10_Chapter/477168_1_En_10_Figb_HTML.gif)你可以用几个规划求解引擎来求解一个模型，方法是为你想要尝试的每个规划求解引擎制作一个模型的深层副本，并在这里指明`optimize! (myCopiedModel(with_optimizer(...)))`(而不是在`Model()`构造函数中，就像你在这个例子中所做的那样。).
...
![$$ \underset{p,s}{\max }100p-2{p}^2+70s-2{s}^2-3 ps $$](img/477168_1_En_10_Chapter/477168_1_En_10_Chapter_TeX_Equd.png)
...
![img/477168_1_En_10_Chapter/477168_1_En_10_Figc_HTML.gif](img/477168_1_En_10_Chapter/477168_1_En_10_Figc_HTML.gif)`solve`函数也直接接受表达式，将它们设置为零。因此，这也是可行的:`solve([dlqp, dlqs, dlλ], [qp, qs, λ])`。
...
![img/477168_1_En_10_Chapter/477168_1_En_10_Figd_HTML.gif](img/477168_1_En_10_Chapter/477168_1_En_10_Figd_HTML.gif)即使被形象化为数字，`q`<sub>`p`</sub>`_num, q`<sub>`s`</sub>`_num`，`and`【λ】`_num`仍然是同体对象。要将它们转换成 Julia 数，可以使用`N(SymPySymbol)`。比如`N(q` <sub> `p` </sub> `_num)`。
...
![$$ vol=\frac{par_1}{1+{e}^{-{par}_2\ast \left( age-{par}_3\right)}} $$](img/477168_1_En_10_Chapter/477168_1_En_10_Chapter_TeX_Eque.png)
...
![img/477168_1_En_10_Chapter/477168_1_En_10_Fig1_HTML.jpg](img/477168_1_En_10_Chapter/477168_1_En_10_Fig1_HTML.jpg)
