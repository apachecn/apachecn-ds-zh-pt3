...
![../images/500382_1_En_14_Chapter/500382_1_En_14_Fig7_HTML.png](../images/500382_1_En_14_Chapter/500382_1_En_14_Fig7_HTML.png)
...
极端的 *y* 值表示异常值，但是普通残差![$$ {\varepsilon}_i={y}_i-{\hat{y}}_i $$](../images/500382_1_En_14_Chapter/500382_1_En_14_Chapter_TeX_IEq31.png)不是量化异常值的好方法，因为它的大小取决于测量单位，例如美元对美分。消除单位的一种方法是将残差除以其标准偏差的估计值，从而获得所谓的标准化残差。
...
![$$ \underset{\boldsymbol{\beta}}{\min }{\left\Vert \boldsymbol{X}\boldsymbol{\beta } -\boldsymbol{y}\right\Vert}_2^2 $$](../images/500382_1_En_14_Chapter/500382_1_En_14_Chapter_TeX_IEq38.png)、s.t .，***【β】***
...
![$$ \underset{\boldsymbol{\beta}}{\min }{\left\Vert \boldsymbol{X}\boldsymbol{\beta } -\boldsymbol{y}+\boldsymbol{\lambda} {\left\Vert \boldsymbol{\beta} \right\Vert}_1\right\Vert}_2^2 $$](../images/500382_1_En_14_Chapter/500382_1_En_14_Chapter_TeX_Equbi.png)T2】

其中![$$ {\left\Vert \boldsymbol{u}\right\Vert}_p={\left(\sum \limits_{i=1}^n{\left|{u}_i\right|}^p\right)}^{\frac{1}{p}} $$](../images/500382_1_En_14_Chapter/500382_1_En_14_Chapter_TeX_IEq39.png)是标准*ℓ*<sub>*p*</sub>——规范。
