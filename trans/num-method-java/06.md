...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig1_HTML.png](img/500382_1_En_6_Chapter/500382_1_En_6_Fig1_HTML.png)
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig2_HTML.png](img/500382_1_En_6_Chapter/500382_1_En_6_Fig2_HTML.png)
...
一元函数的一阶导数最简单，也最容易解释。它是函数在某一点的斜率。两点之间的斜率是两点之间的函数值变化δ*f*除以两点之差δ*x*的商![$$ \frac{\Delta f}{\Delta x} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq1.png)。连接这两点的线称为两点间函数的*割线*(图 [6-3](img/#Fig3) 中的红线)。当一个点向另一个点移动时，割线移动。当一点完全移入与另一点重叠时(即两点成为同一点)，割线成为该点函数的切线(图 [6-3](#Fig3) 中的黑线)。切线的斜率定义为函数在接触点的斜率，因此是函数在该点的一阶导数。换句话说，一阶导数是当步长δ*x*取无穷小时的差的商。当δ*x*足够小时，商就是一阶导数![$$ \frac{df}{dx} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq2.png)的良好近似值。取决于我们如何选择这两个点，我们有不同的有限差分。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig3_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig3_HTML.jpg)
...
![$$ f\left({x}_0+h\right)=f\left({x}_0\right)+{hf}^{\prime}\left({x}_0\right)+\frac{h^2}{2!}{f}^{\prime \prime}\left(\xi \right),{x}_0\le \xi \le {x}_0+h $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equb.png)

![$$ {f}^{\prime}\left({x}_0\right)=\frac{f\left({x}_0+h\right)-f\left({x}_0\right)}{h}-\frac{h}{2!}{f}^{\prime \prime}\left(\xi \right),{x}_0\le \xi \le {x}_0+h $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equc.png)

![$$ \approx \frac{f\left({x}_0+h\right)-f\left({x}_0\right)}{h} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equd.png)

错误术语如下:

![$$ R(x)=\left\Vert {f}^{\prime}\left({x}_0\right)-\frac{f\left({x}_0+h\right)-f\left({x}_0\right)}{h}\right\Vert =\frac{h}{2!}{f}^{\prime \prime}\left(\xi \right)=\mathrm{O}(h) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Eque.png)
...
![$$ {f}^{\prime}\left({x}_0\right)\approx \frac{f\left({x}_0\right)-f\left({x}_0-h\right)}{h} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equf.png)

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig4_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig4_HTML.jpg)
...
![$$ f\left({x}_0-h\right)=f\left({x}_0\right)-{hf}^{\prime}\left({x}_0\right)+\frac{h^2}{2!}{f}^{\prime \prime}\left(\xi \right),{x}_0-h\le \xi \le {x}_0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equg.png)

![$$ {f}^{\prime}\left({x}_0\right)=\frac{f\left({x}_0\right)-f\left({x}_0-h\right)}{h}+\frac{h}{2!}{f}^{\prime \prime}\left(\xi \right),{x}_0-h\le \xi \le {x}_0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equh.png)

误差项与正向差的误差项相同。

![$$ R(x)=\left\Vert {f}^{\prime}\left({x}_0\right)-\frac{f\left({x}_0\right)-f\left({x}_0-h\right)}{h}\right\Vert =\frac{h}{2!}{f}^{\prime \prime}\left(\xi \right)=\mathrm{O}(h) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equi.png)T2】
...
*![$$ {f}^{\prime}\left({x}_0\right)\approx \frac{f\left({x}_0+h\right)-f\left({x}_0-h\right)}{2h} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equj.png)*

见图 [6-5](#Fig5) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig5_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig5_HTML.jpg)
...
![$$ f\left({x}_0+h\right)=f\left({x}_0\right)+h{f}^{\prime}\left({x}_0\right)+\frac{h^2}{2!}{f}^{\prime \prime}\left(\xi \right)+\frac{h^3}{3!}{f}^{\prime \prime \prime}\left({\xi}_1\right),{x}_0\le {\xi}_1\le {x}_0+h $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equk.png)

![$$ f\left({x}_0-h\right)=f\left({x}_0\right)-h{f}^{\prime}\left({x}_0\right)+\frac{h^2}{2!}{f}^{\prime \prime}\left(\xi \right)-\frac{h^3}{3!}{f}^{\prime \prime \prime}\left({\xi}_2\right),{x}_0-h\le {\xi}_2\le {x}_0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equl.png)

减去这两个方程，我们就有了这个:

![$$ {f}^{\prime}\left({x}_0\right)=\frac{f\left({x}_0+h\right)-f\left({x}_0-h\right)}{2h}-\frac{h^2}{3!}{f}^{\prime \prime \prime}\left({\xi}_1\right),{x}_0\le {\xi}_1\le {x}_0+h $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equm.png)

错误术语如下:

![$$ R(x)=\left\Vert {f}^{\prime}\left({x}_0\right)-\frac{f\left({x}_0+h\right)-f\left({x}_0-h\right)}{2h}\right\Vert $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equn.png)

![$$ =\frac{h^2}{3!}{f}^{\prime \prime \prime}\left(\xi \right)=\mathrm{O}\left({h}^2\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equo.png)

中心差有*h*T2】2 的 big-O 误差。这意味着误差二次趋近于 0，比线性更快。该误差项小于前向和后向差。中心差异比向前和向后差异更准确，因此，如果数据值在过去和将来都可用，则中心差异更可取。

对于前面的例子，我们想计算下面函数在 *x* = 2:

![$$ f(x)=-\left({x}^2-4x+6\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equp.png)

的一阶导数

向前差分给出负结果是因为割线向下倾斜，向后差分给出正结果是因为割线向上倾斜，中心差分说![$$ \frac{df}{dx}=0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq3.png)，这是正确答案。
...
![$$ {f}^{\prime \prime }(x)={\left({f}^{\prime }(x)\ \right)}^{\prime } $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equq.png)

通过归纳，如果 *f* ( *x* )的(*n*—1)阶导数存在且可微，那么 *n* 阶导数定义如下:

![$$ {f}^{(n)}(x)={\left({f}^{\left(n-1\right)}(x)\ \right)}^{\prime } $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equr.png)
...
![$$ {f}^{\prime \prime }(x)=\frac{f\left(x+2h\right)-2f\left(x+h\right)+f(x)}{h^2}+O\left({h}^2\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equs.png)

二阶导数向后差分:

![$$ {f}^{\prime \prime }(x)=\frac{f(x)-2f\left(x-h\right)+f\left(x-2h\right)}{h^2}+O\left({h}^2\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equt.png)

二阶导数中心差分:

![$$ {f}^{\prime \prime }(x)=\frac{f\left(x+h\right)-2f(x)+f\left(x-h\right)}{h^2}+O\left({h}^2\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equu.png)

三阶导数向前差分:

![$$ {f}^{\prime \prime \prime }(x)=\frac{f\left(x+3h\right)-3f\left(x+2h\right)+3f\left(x+h\right)-f(x)}{h^3}+O\left({h}^3\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equv.png)

三阶导数向后差分:

![$$ {f}^{\prime \prime \prime }(x)=\frac{f(x)-3f\left(x-h\right)+3f\left(x-2h\right)-f\left(x-3h\right)}{h^3}+O\left({h}^3\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equw.png)

三阶导数中心差分:

![$$ {f}^{\prime \prime \prime }(x)=\frac{f\left(x+2h\right)-2f\left(x+h\right)+2f\left(x-h\right)-f\left(x-2h\right)}{2{h}^3}+O\left({h}^3\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equx.png)

一般来说，我们有以下内容。

*n*-阶导数向前差分:

![$$ {\Delta }_h^n\left[f\right](img/x)=\sum \limits_{i=0}^n{\left(-1\right)}^{n-i}\left(\begin{array}{c}n\\ {}i\end{array}\right)f\left(x+ ih\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equy.png)

*n*-阶导数向后差分:

![$$ {\nabla}_h^n\left[f\right](img/x)=\sum \limits_{i=0}^n{\left(-1\right)}^{n-i}\left(\begin{array}{c}n\\ {}i\end{array}\right)f\left(x- ih\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equz.png)

*n*-阶导数中心差分:

![$$ {\delta}_h^n\left[f\right](img/x)=\sum \limits_{i=0}^n{\left(-1\right)}^{n-i}\left(\begin{array}{c}n\\ {}i\end{array}\right)f\left(x+\left(\frac{n}{2}-i\right)h\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equaa.png)

![$$ \left(\begin{array}{c}n\\ {}i\end{array}\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq4.png)是二项式系数。帕斯卡三角形的每一行都为 *i* 的每个值提供了系数。
...
![$$ \frac{dy}{dx}=-2x+4 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equab.png)
...
![$$ \frac{d^2y}{d{x}^2}=-2 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equac.png)
...
![$$ {D}_xf={f}_x\left(x,y\right)=\frac{\partial f\left(x,y\right)}{\partial x} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equad.png)

它们可以使用有限差分进行数值计算，就像第 [6.2](#Sec6) 节中的任何一元函数一样，除了我们在平面或更高维域上而不是在轴上施加网格。

关于 *x* 两次的二阶偏导数可以写成:

![$$ {D}_{xx}f={f}_{xx}\left(x,y\right)=\frac{\partial^2f\left(x,y\right)}{\partial {x}^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equae.png)

二阶混合偏导数是指我们先对一个变量求导，然后再对另一个变量求导。例如，先相对于 *x* 再相对于 *y* 的二阶混合偏导数可以写成:

![$$ {D}_{xy}f={f}_{xy}\left(x,y\right)=\frac{\partial }{\partial y}\frac{\partial f\left(x,y\right)}{\partial x} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equaf.png)

高阶偏导数和混合导数是这样的:

![$$ \frac{\partial^{i+j+k}f}{\partial {x}^i\partial {y}^j\partial {z}^k}={\partial}_x^i{\partial}_y^j{\partial}_z^kf $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equag.png)
...
![$$ z=f\left(x,y\right)={x}^2+ xy+{y}^2 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equah.png)
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig6_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig6_HTML.jpg)
...
![$$ \frac{\partial z}{\partial x}=2x+y $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equai.png)

见图 [6-7](#Fig7) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig7_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig7_HTML.jpg)
...
![$$ f\left(x,y,z\right)= xy+2 xyz $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equaj.png)

以下代码片段计算这两个混合偏导数:

![$$ {D}_{xy}f=1+2z $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equak.png)

![$$ {D}_{yx}f=1+2z $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equal.png)
...
**![$$ \nabla f\left(\boldsymbol{x}\right)=\left[\begin{array}{c}\frac{\partial f}{\partial {x}_1}\left(\boldsymbol{x}\right)\\ {}\vdots \\ {}\frac{\partial f}{\partial {x}_n}\left(\boldsymbol{x}\right)\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equam.png)**

 **每个分量![$$ \frac{\partial f}{\partial {x}_i}\left(\boldsymbol{x}\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq6.png)是函数沿轴的偏导数，是该方向的变化率。梯度向量就像一元函数的一阶导数，斜率或正切。可以解释为上升最快的方向和速度。如果函数在 *** x *** 点的梯度不为零，那么梯度的方向就是函数从 *** x *** 增加最快的方向，梯度的大小就是那个方向的增加率，最大的绝对方向导数。此外，梯度是一个点的零向量当且仅当它是一个静止点(导数为零)。因此，梯度在最优化理论中起着基本的作用。我们将在第 [9](img/09.html) 章中看到，许多优化算法，如梯度下降，都使用了梯度。
...
***![$$ f\left(\boldsymbol{x}\right)\approx f\left({\boldsymbol{x}}_{\mathbf{0}}\right)+\nabla f\left({\boldsymbol{x}}_{\mathbf{0}}\right)\bullet \left(\boldsymbol{x}-{\boldsymbol{x}}_{\mathbf{0}}\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equan.png)***
...
![$$ f\left(x,y\right)=x\exp \left(-\left({x}^2+{y}^2\right)\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equao.png)

参见图 [6-8](#Fig8) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig8_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig8_HTML.jpg)
...
![$$ f\left(x,y\right)=-{\left({\cos}^2x+{\cos}^2y\right)}^2 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equap.png)

参见图 [6-9](#Fig9) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig9_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig9_HTML.jpg)
...
![$$ {\boldsymbol{J}}_{ij}=\frac{\partial {f}_i}{\partial {x}_j} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equaq.png)

或者明确地，

![$$ \boldsymbol{J}=\left[\frac{\partial \boldsymbol{f}}{\partial {x}_1}\cdots \frac{\partial \boldsymbol{f}}{\partial {x}_n}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equar.png)

![$$ =\left[\begin{array}{c}{\nabla}^T{f}_1\\ {}\vdots \\ {}{\nabla}^T{f}_m\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equas.png)

![$$ =\left[\begin{array}{ccc}\frac{\partial {f}_1}{\partial {x}_1}&amp; \cdots &amp; \frac{\partial {f}_1}{\partial {x}_n}\\ {}\vdots &amp; \ddots &amp; \vdots \\ {}\frac{\partial {f}_m}{\partial {x}_1}&amp; \cdots &amp; \frac{\partial {f}_m}{\partial {x}_n}\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equat.png)
...
****![$$ \boldsymbol{f}\left(\boldsymbol{y}\right)=\boldsymbol{f}\left(\boldsymbol{x}\right)+{\boldsymbol{J}}_{\boldsymbol{f}}\left(\boldsymbol{y}-\boldsymbol{x}\right)+O\left(\left\Vert \boldsymbol{y}-\boldsymbol{x}\right\Vert \right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equau.png)****
...
![$$ \boldsymbol{F}\left(\left[\begin{array}{c}x\\ {}y\end{array}\right]\right)=\left[\begin{array}{c}{f}_1\left(x,y\right)\\ {}{f}_2\left(x,y\right)\end{array}\right]=\left[\begin{array}{c}{x}^2y\\ {}5x+\sin y\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equav.png)

雅可比如下:

![$$ {\boldsymbol{J}}_{\boldsymbol{F}}\left(x,y\right)=\left[\begin{array}{cc}\frac{\partial {f}_1}{\partial x}&amp; \frac{\partial {f}_1}{\partial y}\\ {}\frac{\partial {f}_2}{\partial x}&amp; \frac{\partial {f}_2}{\partial y}\end{array}\right]=\left[\begin{array}{cc}2 xy&amp; {x}^2\\ {}5&amp; \cos y\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equaw.png)

雅可比行列式如下:

![$$ \left\Vert {\boldsymbol{J}}_{\boldsymbol{F}}\left(x,y\right)\right\Vert =2 xy\cos y-5{x}^2 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equax.png)
...
![$$ \boldsymbol{F}\left(\left[\begin{array}{c}{x}_1\\ {}{x}_2\\ {}{x}_3\end{array}\right]\right)=\left[\begin{array}{c}5{x}_2\\ {}4{x_1}^2-2\sin \left({x}_2{x}_3\right)\\ {}{x}_2{x}_3\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equay.png)

雅可比如下:

![$$ {\boldsymbol{J}}_{\boldsymbol{F}}\left(x,y\right)=\left[\begin{array}{ccc}0&amp; 5&amp; 0\\ {}8{x}_1&amp; -2{x}_3\cos \left({x}_2{x}_3\right)&amp; -2{x}_2\cos \left({x}_2{x}_3\right)\\ {}0&amp; {x}_3&amp; {x}_2\end{array}\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equaz.png)

雅可比行列式如下:

![$$ \left\Vert {\boldsymbol{J}}_{\boldsymbol{F}}\left({x}_1,{x}_2,{x}_3\right)\right\Vert =-40{x}_1{x}_2 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equba.png)
...
![$$ f(x)=a\exp \left(-\frac{{\left(x-b\right)}^2}{2{c}^2}\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbf.png)
...
![$$ erzz=\frac{2}{\pi }{\int}_0^z{e}^{-{t}^2} dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbg.png)
...
![$$ B\left(x,y\right)={\int}_0^1{t}^{x-1}{\left(1-t\right)}^{y-1} dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbh.png)
...
![$$ B\left(x;p,q\right)={\int}_0^x{t}^{p-1}{\left(1-t\right)}^{q-1} dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbi.png)

当 *x* = 1 时，不完全贝塔函数与完全贝塔函数重合。

正则不完全 beta 函数(或简称正则 beta 函数)是由不完全 beta 函数和完全 beta 函数定义的。

![$$ {I}_x\left(p,q\right)=\frac{B\left(x;p,q\right)}{B\left(p,q\right)} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbj.png)T2】
...
![$$ \Gamma (z)={\int}_0^{\infty }{x}^{z-1}{e}^{-x} dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbk.png)
...
![$$ p(x)={a}_n{x}^n+\cdots {a}_1x+{a}_0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbl.png)

![$$ \frac{dp}{dx}=n{a}_n{x}^{n-1}+\cdots {a}_2x+{a}_1 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbm.png)
...
![$$ I={\int}_a^bf(x) dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbn.png)

符号 *dx* ，称为变量 *x* 的微分，表示积分的变量为 *x* 。这意味着微分中的 *x* 的微小变化。积分是计算定积分值的过程。微积分第一基本定理说，积分的导数就是被积函数。所以，我们有时称积分为函数的反导数。参见图 [6-10](#Fig10) 。

![$$ f(x)=\frac{d}{dx}{\int}_0^xf(t) dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbo.png)

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig10_HTML.png](img/500382_1_En_6_Chapter/500382_1_En_6_Fig10_HTML.png)
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig11_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig11_HTML.jpg)
...
![$$ a={x}_0&lt;{x}_1&lt;\cdots {x}_n=b $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbp.png)
...
![$$ {S}_n=\sum \limits_{i=0}^{n-1}f\left({t}_i\right)\left({x}_{i+1}-{x}_i\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbq.png)

当我们取 *n* 趋于无穷的极限时，黎曼和就变成了整数值。【T2![$$ I=\underset{n\to \infty }{\lim }{S}_n $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbr.png)
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig12_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig12_HTML.jpg)
...
![$$ {L}_1(x)=\frac{f(b)-f(a)}{b-a}\left(x-a\right)+f(a) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbs.png)

线下的面积是梯形的面积，即底边(平行边)之和乘以高度(底边之间的垂直距离)，然后除以 2。我们也可以做适当的积分来得到相同的结果。

把 *f* ( *x* )换成 *L* <sub>1</sub> ( *x* )，我们就有了这个:

![$$ {\int}_a^bf(x) dx\approx {\int}_a^b{L}_1(x) dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbt.png)

![$$ ={\int}_a^b\left[\frac{f(b)-f(a)}{b-a}\left(x-a\right)+f(a)\right] dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbu.png)

![$$ =\frac{f(a)+f(b)}{2}\left(b-a\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbv.png)

对于一个函数 *f* ( *x* )和一个区间[ *a* ， *b* ]，我们可以把区间分成 *N* 个子区间。然后我们将这个梯形法则应用于每个子区间，并将它们相加。

让

![$$ \Delta  x=\frac{b-a}{N} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbw.png)

![$$ {\int}_a^bf(x) dx\approx \frac{\Delta  x}{2}\sum \limits_{k=1}^N\left(f\left({x}_{k-1}\right)+f\left({x}_k\right)\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbx.png)

可以证明，假设*f*<sup>’</sup>(*x*)存在并且在 *a* ， *b* ]上连续，对于某些*ξ*∈*a*，*b*:

![$$ \varepsilon =-\frac{{\left(b-a\right)}^3}{12N}{f}^{\prime \prime}\left(\xi \right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equby.png)
...
辛普森公式不是用直线代替函数，而是用二次函数或抛物线代替 *f* ( *x* )。该区间被分成两部分，给出三个点: *a* 、 *b* 和中点![$$ m=\frac{a+b}{2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq7.png)。二次函数如下:

![$$ {L}_2(x)= $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equbz.png)

![$$ \frac{\left(x-m\right)\left(x-b\right)}{\left(a-m\right)\left(a-b\right)}f(a)+\frac{\left(x-a\right)\left(x-b\right)}{\left(m-a\right)\left(m-b\right)}f(m)+\frac{\left(x-m\right)\left(x-a\right)}{\left(b-m\right)\left(b-a\right)}f(b) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equca.png)

从几何的角度来看，辛普森公式计算抛物线围成的弯曲梯形的面积来近似为 *f* ( *x* )围成的面积。见图 [6-13](#Fig13) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig13_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig13_HTML.jpg)
...
![$$ {\int}_a^bf(x) dx\approx {\int}_a^b{L}_2(x) dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcb.png)

![$$ =\frac{b-a}{6}\left[f(a)+4f\left(\frac{a+b}{2}\right)+f(b)\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcc.png)

![$$ =\frac{h}{3}\left[f(a)+4f\left(\frac{a+b}{2}\right)+f(b)\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcd.png)

![$$ h=\frac{b-a}{2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq8.png)是每个分区中的步长。因为公式中的![$$ \frac{1}{3} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq9.png)，这个辛普森法则常被称为辛普森 1/3 法则。

对于一个函数 *f* ( *x* )和一个区间[ *a* ， *b* ]，我们可以把区间分成 *N* 个子区间。然后，我们将这个辛普森规则应用于每个子区间，并将它们相加。我们有以下:

![$$ {\int}_a^bf(x) dx\approx \frac{h}{3}\sum \limits_{j=1}^{N/2}\left[f\left({x}_{2j-2}\right)+4f\left({x}_{2j-1}\right)+f\left({x}_{2j}\right)\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equce.png)

对于两次连续可微的函数，辛普森法则有望改进梯形法则。然而，对于更粗糙的函数，梯形法则可能更可取。可以证明，假设四阶导数 *f* <sup>(4)</sup> ( *x* )存在并且在 *a* ， *b* ]上连续，对于某些*ξ*∈】*a*，*b*:

![$$ \varepsilon =-\frac{h^4}{180}\left(b-a\right){f}^{(4)}\left(\xi \right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcf.png)
...
*x*<sub>T3】IT5】=*a*+*ih*，![$ h=\frac{b-a}{n} $](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq10.png)</sub>

对于开放式公式，等距点如下所示:

*x*<sub>T3】IT5】=*a*+(*I*+1)*h*，![$ h=\frac{b-a}{n+2} $](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq11.png)</sub>

对于封闭的公式，可以构造一个 *n* 次差分多项式，如下图:

![$$ {L}_n(x)={\sum}_{k=0}^n\frac{w(x)}{\left(x-{x}_k\right){w}^{\prime}\left({x}_k\right)}f\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcg.png)

其中*w*(*x*)=(*x*xx<sub>0</sub>)(*x*x*x*t14】1)⋯(*x*x*x*t20】t21【nt23)。

将 *f* ( *x* )替换为*L*<sub>*n*</sub>(*x*)，我们有了以下:

![$$ {\int}_a^bf(x) dx\approx {\int}_a^b{L}_n(x) dx={\int}_a^b\left({\sum}_{k=0}^n\frac{w(x)}{\left(x-{x}_k\right){w}^{\prime}\left({x}_k\right)}f\left({x}_k\right)\right) dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equch.png)

![$$ ={\sum}_{i=0}^n\left({\int}_a^b\frac{w(x)}{\left(x-{x}_k\right){w}^{\prime}\left({x}_k\right)} dx\right)f\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equci.png)

![$$ ={\sum}_{i=0}^n{A}_kf\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcj.png)

其中系数![$$ {A}_k={\int}_a^b\frac{w(x)}{\left(x-{x}_k\right){w}^{\prime}\left({x}_k\right)} dx. $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq12.png)

这个公式被称为牛顿-科特斯公式。这些系数被称为牛顿-柯特斯系数。要使用该公式，我们需要计算系数*A*<sub>T3】kT5。替换 *x* = *a* + *th* 。我们有以下:</sub>

![$$ w(x)=w\left(a+ th\right)={h}^{n+1}t\left(t-1\right)\cdots \left(t-n\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equck.png)

![$$ {w}^{\prime }(x)={h}^n{\left(-1\right)}^{n-1}\left(k!\right)\left(n-k\right)! $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcl.png)

![$$ {A}_k={\int}_a^b\frac{w(x)}{\left(x-{x}_k\right){w}^{\prime}\left({x}_k\right)} dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcm.png)

![$$ ={\int}_0^n\frac{h^{n+1}t\left(t-1\right)\cdots \left(t-n\right)}{h^n{\left(-1\right)}^{n-1}\left(k!\right)\left(n-k\right)!h\left(t-k\right)} hdt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcn.png)

让

![$$ {C}_k^{(n)}=\frac{{\left(-1\right)}^{n-k}}{n\left(k!\right)\left(n-k\right)!}{\int}_0^n\frac{t\left(t-1\right)\cdots \left(t-n\right)}{\left(t-k\right)} dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equco.png)

所以

![$$ {A}_k=\left(b-a\right){C}_k^{(n)} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcp.png)

我们看到 *A* <sub>*k*</sub> 是一个常数，它只依赖于区间[ *a* ， *b* 和分区数 *n* 而不依赖于函数。因此，可以预先计算牛顿-柯特斯系数。

梯形公式和辛普森公式是牛顿-科特斯公式的特例。当 *n* = 1 时，牛顿-科特斯公式如下:

![$$ {L}_1(x)=\frac{b-a}{2}\left[f(a)+f(b)\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcq.png)

这就是梯形公式。

当 *n* = 2 时，牛顿-科特斯公式如下:

![$$ {L}_2(x)=\frac{b-a}{6}\left[f(a)+4f\left(\frac{a+b}{2}\right)+f(b)\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcr.png)

这是辛普森公式。

当 *n* = 4 时，牛顿-科特斯公式如下:

![$$ C=\frac{b-a}{90}\left[7f\left({x}_0\right)+32f\left({x}_1\right)+12f\left({x}_2\right)+32f\left({x}_3\right)+7f\left({x}_4\right)\right] $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcs.png)

以及*x*<sub>T3】IT5】=*a*+*KH*(*k*= 0，1，2，3，4)和![$ h=\frac{b-a}{4} $](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq13.png)。见图 [6-14](img/#Fig14)</sub>

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig14_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig14_HTML.jpg)
...
![$$ {\int}_a^bf(x) dx\approx {\sum}_{k=0}^n{A}_kf\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equct.png)

如果 *f* ( *x* )是一个次数为 *n* + 1 的多项式，那么右手边只是一个近似值。据说求积公式有一个 *n* 级的代数精度。

对于 *n* = 1，梯形求积法则有这个误差，据说有初等代数精度。

![$$ \varepsilon =-\frac{{\left(b-a\right)}^3}{12N}{f}^{\prime \prime}\left(\xi \right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq14.png)、*【a】***【b】**

 *对于 *n* = 2，辛普森求积法则有这个误差，据说有三次代数精度。

![$$ \varepsilon =-\frac{h^4}{180}\left(b-a\right){f}^{(4)}\left(\xi \right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq15.png)、*【a】***【b】**

 *对于一般的 *n* ，误差项如下:

![$$ \varepsilon =\frac{f^{\left(n+1\right)}\left(\xi \right)}{\left(n+1\right)!}w(x) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq16.png)、*【a】***【b】**
...
假设*f*(*x*<sub>T5】I</sub>)(*x*<sub>*I*</sub>为网格点)的舍入误差为![$$ {\varepsilon}_i,{\varepsilon}_{max}=\underset{0\le i\le n}{\mathit{\max}}\mid {\varepsilon}_i\mid $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq17.png)，牛顿-科特斯公式的误差如下:

![$$ \varepsilon =\left|b-a\right|\cdotp \left|{\sum}_{i=0}^n{C}_i^{(n)}{\varepsilon}_i\right|\le \mid \left(b-a\right)\mid \cdotp {\varepsilon}_{max}\cdotp \mid {\sum}_{i=0}^n{C}_i^{(n)}\mid $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcu.png)

最后一项![$$ {\sum}_{i=0}^n\mid {C}_i^{(n)}\mid $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq18.png)，随着 *n* 的增加而增加。这会导致近似的误差增大，所以牛顿-科特斯公式对于大 *n* 是不稳定的。因此，在实践中牛顿-柯特斯公式很少用于 *n* ≥ 8。

考虑这个集成以下函数的例子:

![$$ I={\int}_0^1 ydx={\int}_0^1\frac{4}{1+{x}^2} dx=\pi $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcv.png)

见图 [6-15](#Fig15)

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig15_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig15_HTML.jpg)
...
![$$ {\int}_0^1 ydx\approx \frac{1-0}{2}\left[\frac{4}{1+1}+\frac{4}{1+0}\right]=3 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcw.png)

见图 [6-16](#Fig16)

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig16_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig16_HTML.jpg)
...
![$$ {\int}_0^1 ydx\approx \frac{1-0}{6}\left[\frac{4}{1+1}+4\frac{4}{1+\frac{1}{4}}+\frac{4}{1+0}\right]\approx 3.1333 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcx.png)

参见图 [6-17](#Fig17) 和图 [6-18](#Fig18) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig18_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig18_HTML.jpg)

图 6-18

π的辛普森公式

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig17_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig17_HTML.jpg)
...
![$$ {x}_0=0,{x}_1=0.2500,{x}_2=0.5000,{x}_3=0.7500,{x}_4=1.0000 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcy.png)

![$$ {\int}_0^1 ydx\approx \frac{b-a}{90}\left[7f\left({x}_0\right)+32f\left({x}_1\right)+12f\left({x}_2\right)+32f\left({x}_3\right)+7f\left({x}_4\right)\right]\approx 3.1421 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equcz.png)

参见图 [6-19](#Fig19) 和图 [6-20](#Fig20) 。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig20_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig20_HTML.jpg)

图 6-20

n=4 时π的牛顿-柯特斯公式

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig19_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig19_HTML.jpg)
...
根据梯形法则的误差估计，可以看出积分(近似)值*T*<sub>T3】nT5】的截断误差大致与 *h* <sup>2</sup> 成正比。因此，当步长除以两倍数量的子间隔时，截断误差*I*T*T*T14】T*n*T17】将减少到原始误差的![$ \frac{1}{4} $](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq19.png)。</sub>

![$$ \frac{I-{T}_{2n}}{I-{T}_n}\approx \frac{1}{4} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equda.png)即

我们可以重新排列这些术语得到如下:

![$$ I-{T}_{2n}\approx \frac{1}{3}\left({T}_{2n}-{T}_n\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdb.png)

可以看出，只要进一步区间划分前后的两个连续积分值 *T* <sub>*n*</sub> 和 *T* <sub>2 *n*</sub> 足够接近，*T*<sub>2*n*</sub>计算结果的误差就会很小。*T*T20】2*n*T23】的误差大致等于![$$ \frac{1}{3}\left({T}_{2n}-{T}_n\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq20.png)。我们可以使用这个误差来补偿*T*T27】2*n*T30】以获得更好的估计。即更准确的近似如下:

![$$ \overline{T}={T}_{2n}+\frac{1}{3}\left({T}_{2n}-{T}_n\right)=\frac{4}{3}{T}_{2n}-\frac{1}{3}{T}_n $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdc.png)

也就是说，我们线性组合使用梯形法则计算的两个整数值 *T* <sub>*n*</sub> 和 *T* <sub>2 *n*</sub> 以获得更精确的近似值。我们可以走得更远。

我们可以通过线性组合梯形序列![$$ \left\{{T}_{2^k}\right\} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq22.png)的值来生成辛普森序列![$$ \left\{{S}_{2^k}\right\} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq21.png)。辛普森序列比梯形序列具有更快的收敛速度。

T3

T5![$$ {S}_n=\overline{T}=\frac{4}{3}{T}_{2n}-\frac{1}{3}{T}_n=\frac{4{T}_{2n}-{T}_n}{4-1} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equde.png)T7】

利用类似的计算，可以表明

![$$ I\approx {S}_{2n}+\frac{1}{15}\left({S}_{2n}-{S}_n\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdf.png)

我们可以进一步线性组合 Simpson 序列的值，以产生收敛速度更快的 Cotes 序列![$$ \left\{{C}_{2^k}\right\} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq23.png)。可以看出

![$$ {C}_{2n}=\frac{16}{15}{S}_{2n}-\frac{1}{15}{S}_n=\frac{4^2{S}_{2n}-{S}_n}{4^2-1} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdg.png)

利用类似的计算，可以表明

![$$ I\approx {C}_{2n}+\frac{1}{63}\left({C}_{2n}-{C}_n\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdh.png)

我们还可以通过线性组合 Cotes 序列的值来产生一个收敛速度更快的 Romberg 序列![$$ \left\{{R}_{2^k}\right\} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq24.png)。

T2

T4![$$ {R}_n=\frac{64}{63}{C}_{2n}-\frac{1}{63}{C}_n=\frac{4^3{C}_{2n}-{C}_n}{4^3-1} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdj.png)T6】
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig21_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig21_HTML.jpg)
...
![$$ I={\int}_0^1 ydx={\int}_0^1\frac{4}{1+{x}^2} dx=\pi $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdk.png)

![$$ f(x)=\frac{4}{1+{x}^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdl.png)

![$$ {T}_1=\frac{1}{2}\left[f(0)+f(1)\right]=3 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdm.png)

![$$ {T}_2=\frac{1}{2}{T}_1+\frac{1}{2}f\left(\frac{1}{2}\right)=3.1 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdn.png)

![$$ {S}_1=\frac{4}{3}{T}_2-\frac{1}{3}{T}_1=3.13333 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdo.png)

![$$ {T}_4=\frac{1}{2}{T}_2+\frac{1}{4}\left[f\left(\frac{1}{4}\right)+f\left(\frac{3}{4}\right)\right]=3.131177 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdp.png)

![$$ {S}_2=\frac{4}{3}{T}_4-\frac{1}{3}{T}_2=3.141569 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdq.png)

![$$ {T}_8=\frac{1}{2}{T}_4+\frac{1}{8}\left[f\left(\frac{1}{8}\right)+f\left(\frac{3}{8}\right)+f\left(\frac{5}{8}\right)+f\left(\frac{7}{8}\right)\right]=3.138989 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdr.png)

![$$ {S}_4=\frac{8}{3}{T}_8-\frac{1}{3}{T}_4=3.141593 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equds.png)

![$$ {C}_1=\frac{16}{15}{S}_2-\frac{1}{15}{S}_1=3.142118 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdt.png)

![$$ {R}_1=\frac{64}{63}{C}_2-\frac{1}{63}{C}_1=3.141586292 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdv.png)

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig22_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig22_HTML.jpg)

图 6-22

龙贝格积分

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig23_HTML.png](img/500382_1_En_6_Chapter/500382_1_En_6_Fig23_HTML.png)
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig25_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig25_HTML.jpg)

图 6-25

高斯正交对梯形规则

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig24_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig24_HTML.jpg)
...
![$$ f(x)=7{x}^3-8{x}^2-3x+3 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdw.png)

积分值如下:

![$$ {\int}_{-1}^1\left(7{x}^3-8{x}^2-3x+3\right) dx=\frac{2}{3} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdx.png)

见图 [6-26](#Fig26)

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig26_HTML.png](img/500382_1_En_6_Chapter/500382_1_En_6_Fig26_HTML.png)
...
![$$ f\left(-1\right)+f(1)=-10 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdy.png)

两点高斯求积规则使用黑色虚线来逼近多项式。它给出了精确的结果。绿色区域的面积大小与红色区域的总和相同。

![$$ f\left(-\sqrt{\frac{1}{3}}\right)+f\left(\sqrt{\frac{1}{3}}\right)=\frac{2}{3} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equdz.png)T2】

一般来说，高斯求积公式(注意，我们将符号从 *A* <sub>*k*</sub> 改为 *w* <sub>*k*</sub> 因为现在系数或权重的计算方式不同)是关于这种形式的积分

![$$ {\int}_a^b\rho (x)f(x) dx\approx \sum \limits_{k=0}^n{w}_kf\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equea.png)
...
![$$ {\int}_{-1}^1\rho (x)f(x) dx\approx \sum \limits_{k=0}^n{w}_kf\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equeb.png)

高斯节点是勒让德多项式的根*P*<sub>*n*</sub>(*x*)。

*P*<sub>*n*</sub>(*x*)是次数为 *n* 的多项式，使得它们正交。两个正交的多项式或函数当且仅当它们满足:

![$$ {\int}_{-1}^1{P}_m(x){P}_n(x) dx=0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq25.png)，如果*n*≦*m*

图 [6-27](#Fig27) 显示了前 11 个勒让德多项式(对于 *n* = 0，⋯，10)。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig27_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig27_HTML.jpg)
...
![img/500382_1_En_6_Chapter/500382_1_En_6_Fig28_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig28_HTML.jpg)
...
![$$ {w}_k=\frac{2}{\left(1-{x}_k^2\right){\left[{P}_n^{\prime}\left({x}_k\right)\right]}^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equec.png)

区间[1，1]内的一些低阶求积规则如图 [6-29](#Fig29) 所示。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig29_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig29_HTML.jpg)
...
![$$ {\int}_{-1}^1f(x) dx\approx \sum \limits_{k=0}^n{w}_kf\left({x}_k\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equed.png)

事实上，对于次数高达 2 *n* + 1 的多项式的函数，方程是精确的。

在 NM Dev 中，做高斯-勒让德求积的类是`GaussLegendreQuadrature`。下面的代码计算这个积分:

![$$ I={\int}_{-1}^1\left({x}^4+{x}^2+x\right) dx=2 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equee.png)
...
![$$ {\int}_0^{\infty }{e}^{-x}f(x) dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equef.png)T2】

高斯节点{ *x* <sub>*k*</sub> }，是拉盖尔多项式*L*<sub>*n*</sub>(*x*)的根。

图 [6-30](#Fig30) 显示了前几个拉盖尔多项式。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig30_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig30_HTML.jpg)
...
![$$ {w}_k=\frac{x_k}{{\left(n+1\right)}^2{\left[{L}_{n+1}\left({x}_k\right)\right]}^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equeg.png)

在 NM Dev 中，做高斯-拉盖尔求积的类是`GaussLaguerreQuadrature`。下面的代码计算这个积分:

![$$ I={\int}_0^{\infty }{e}^{-x}\left({x}^2+2x+1\right) dx=5 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equeh.png)
...
![$$ {\int}_{-\infty}^{\infty }{e}^{-{x}^2}f(x) dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equei.png)

高斯节点{ *x* <sub>*k*</sub> }，是物理学家版本的埃尔米特多项式*H*<sub>*n*</sub>(*x*)的根。

图 [6-31](#Fig31) 和图 [6-32](#Fig32) 显示了前几个埃尔米特多项式。

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig32_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig32_HTML.jpg)

图 6-32

前六个埃尔米特多项式

![img/500382_1_En_6_Chapter/500382_1_En_6_Fig31_HTML.jpg](img/500382_1_En_6_Chapter/500382_1_En_6_Fig31_HTML.jpg)
...
![$$ {w}_k=\frac{2^{n-1}n!\sqrt{\pi }}{n^2{\left[{H}_{n-1}\left({x}_k\right)\right]}^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equej.png)

在 NM Dev 中，做高斯-埃尔米特求积的类是`GaussHermiteQuadrature`。下面的代码计算这个积分:

![$$ I={\int}_0^{\infty }{e}^{-{x}^2}\left({x}^2+2x+1\right) dx=\frac{3\sqrt{\pi }}{2}\approx 2.658681 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equek.png)
...
![$$ {\int}_{-1}^1\frac{f(x)}{\sqrt{1-{x}^2}} dx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equel.png)

高斯节点{ *x* <sub>*k*</sub> }，如下:

![$$ {x}_k=\cos \left(\frac{2i-1}{2n}\pi \right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equem.png)

高斯系数{*w*<sub>T3】k</sub>}，如下:

![$$ {w}_k=\frac{\pi }{n} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equen.png)

在 NM Dev 中，做高斯-切比雪夫求积的类是`GaussChebyshevQuadrature`。下面的代码计算这个积分:

![$$ I={\int}_{-1}^1\frac{x^2+2x+1}{\sqrt{1-{x}^2}} dx=\frac{3\pi }{2}\approx 4.712389 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equeo.png)
...
![$$ x=\varphi (t) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equep.png)

如

![$$ dx={\varphi}^{\prime }(t) dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equeq.png)

然后我们可以用在 *x* 中的积分代替 *t* 中的积分。

![$$ {\int}_a^bf\left(\varphi (t)\right){\varphi}^{\prime }(t) dx={\int}_{\varphi (a)}^{\varphi (b)}f(x) du $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equer.png)

举个例子会更容易理解。假设我们要计算如下:

![$$ I={\int}_0^2t\cos \left({t}^2+1\right) dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Eques.png)

我们注意到，如果我们设置这个:

![$$ x={t}^2+1 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equet.png)

于是我们有了以下:

![$$ dx=2 tdt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equeu.png)

或者以下:

![$$ \frac{1}{2} dx= tdt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equev.png)

把这些代入原积分，去掉 *t* ，我们就有了:

![$$ I={\int}_0^2t\cos \left({t}^2+1\right) dx={\int}_{x=1}^{x=5}\frac{1}{2}\cos xdx $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equew.png)

在 *x* 中的新积分就没那么吓人了。【T2![$$ I=\frac{1}{2}{\int}_1^5\cos xdx=\frac{1}{2}\left(\sin 5-\sin 1\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equex.png)
...
![$$ x(t)=\frac{\left(b-a\right)t+\left(a+b\right)}{2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equey.png)

![$$ {x}^{\prime }(t)=\frac{\left(b-a\right)}{2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equez.png)

![$$ {\int}_a^bf(x) dx={\int}_{-1}^1\frac{\left(b-a\right)}{2}f\left(\frac{\left(b-a\right)t+\left(a+b\right)}{2}\right) dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfa.png)
...
3.  比![$$ \frac{1}{x^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq26.png)更快地向无穷大递减的任何函数

用于这种替换的积分器应该使用开放公式，以避免计算端点 *t* = 0。替换如下:

![$$ x(t)=\frac{1}{t} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfb.png)

![$$ {x}^{\prime }(t)=-\frac{1}{t^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfc.png)

![$$ {\int}_a^bf(x) dx={\int}_{1/b}^{1/a}\frac{1}{t^2}f(t) dt, ab&gt;0 $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfd.png)
...
![$$ x(t)=-\log t $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfe.png)

![$$ {x}^{\prime }(t)=-\frac{1}{t} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equff.png)

![$$ {\int}_a^{\infty }f(x) dx={\int}_0^{e^a}\frac{f\left(-\log t\right)}{t} dt $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfg.png)
...
混合规则适用于在无穷远处快速下降的函数，例如，*e*<sup>T5】x</sup>或![$$ {e}^{x^2} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_IEq27.png)。积分区间为[0，∞)。使用这种转换的棘手部分是为 *t* 找出一个好的范围。如果有关于被积函数的可用信息，`SubstitutionRule.ta()`和`SubstitutionRule.tb()`应被覆盖。替换如下:

![$$ x(t)={e}^{t-{e}^{-t}} $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfh.png)
...
![$$ x(t)=\frac{b+a}{2}+\frac{b-a}{2}\tanh \left(c\sinh t\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfi.png)
...
![$$ x(t)=\sinh \left(c\sinh t\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfj.png)
...
![$$ x(t)=\exp \left(2c\sinh t\right) $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfk.png)
...
![$$ {\int}_a^bf(x) dx={\int}_0^{{\left(b-a\right)}^{1-\gamma }}\frac{t^{\frac{\gamma }{1-\gamma }}f\left({t}^{\frac{1}{1-\gamma }}+a\right)}{1-\gamma } dt,b&gt;a $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfl.png)

对于上限处的奇点，我们有(*x*—*b*)<sup>—*γ*</sup>在 *x* = *b* 附近发散。0 ≤ *γ* ≤ 1。替换规则如下:

![$$ {\int}_a^bf(x) dx={\int}_0^{{\left(b-a\right)}^{1-\gamma }}\frac{t^{\frac{\gamma }{1-\gamma }}f\left(b-{t}^{\frac{1}{1-\gamma }}\right)}{1-\gamma } dt,b&gt;a $$](img/500382_1_En_6_Chapter/500382_1_En_6_Chapter_TeX_Equfm.png)
